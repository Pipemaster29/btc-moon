...
import { getAfericao, getGarimpo } from "@/lib/garimpo";
...
export default async function Radar() {
  const [snapshot, placar, guardada, garimpo, afericao] = await Promise.all([
    getSnapshot(),
    getPlacar(),
    getCarteira(),
    getGarimpo(),
  ...
  return (
    <div className="flex flex-col flex-1 bg-zinc-50 font-sans dark:bg-black">
      <main className="flex-1 max-w-6xl mx-auto w-full px-6 py-12 flex flex-col gap-8">
        ...
        {garimpo && <GarimpoPanel g={garimpo} afericao={afericao} />}
